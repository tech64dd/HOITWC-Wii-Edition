...
int main() {
	...
	int day, month, year;
	puts("The Wii uses the PowerPC 750CL CPU, a minor iteration on the PowerPC 750 design.\nThis CPU is also known as the \"G3\" from Apple.");
	...
	printf("Today is: %s %d, %d.  It has been %d days, or %d years, %d months, and %d days, since the release of the PowerPC 750.\n",
			months[month],
			day,
			year,
			numTotalDays,
